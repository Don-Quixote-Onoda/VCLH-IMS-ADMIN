            ...
            <div class="bg-secondary rounded h-100 p-4">
                <form action="{{ route('rooms-manager.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="room_number" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Number of Beds</label>
                        <input type="number" name="number_of_beds" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp">
                    </div>
