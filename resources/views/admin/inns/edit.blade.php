        ...
        <div class="row mx-auto d-flex justify-content-center my-5">
            <div class="col-sm-12 col-xl-8">
                <div class="bg-secondary rounded h-100 p-4">
                    <form action="/admin/inns-admin/{{ $inn->id }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="mb-3">
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-sm-6  bg-secondary p-5 rounded">
            <form action="/admin/inns-admin/{{$inn->id}}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Image</label>
                    <input type="file" name="inn_image" class="form-control" value="{{$inn->room_image}}" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
